...
static const char *colors[][3] = {          /* 颜色设置 ColFg, ColBg, ColBorder */ 
    [SchemeNorm]      = { BRI_BLACK , CLR_BG, BRI_BLACK },
    [SchemeSel]       = { BRI_GREEN , CLR_BG, BRI_GREEN },
    [SchemeSelGlobal] = { NOR_YELLOW, CLR_BG, NOR_YELLOW },
    [SchemeHid]       = { BRI_BLACK , CLR_BG, NULL },
    [SchemeSystray]   = { NULL      , CLR_BG, NULL },
    [SchemeUnderline] = { CLR_BG    , NOR_RED,NULL }, 
    [SchemeNormTag]   = { NOR_WHITE , CLR_BG, NULL },
    [SchemeSelTag]    = { BRI_RED   , CLR_BG, NULL },
    [SchemeBarEmpty]  = { NULL      , CLR_BG, NULL },
};
