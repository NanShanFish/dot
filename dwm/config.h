...
/*
telegram blue 00a735
tjf_agfj_hxxi bd93f9
cold_blue 82aaff
*/

static const char *colors[][3]           = {          /* 颜色设置 ColFg, ColBg, ColBorder */ 
    [SchemeNorm] = { "#d4be98", "#282828", "#565656" },
    [SchemeSel] = { "#e78a4e", "#282828", "#7daea3" },
    [SchemeSelGlobal] = { "#ffce96", "#282828", "#e9b143" },
    [SchemeHid] = { "#304050", "#282828", NULL },
    [SchemeSystray] = { NULL, "#282828", NULL },
    [SchemeUnderline] = { "#282828", "#3b4261", NULL }, 
    [SchemeNormTag] = { "#d4be98", "#282828", NULL },
    [SchemeSelTag] = { "#d3869b", "#282828", NULL },
...
static Key keys[] = {
    ...
    { MODKEY,              XK_space,  spawn, SHCMD("st -c float") },                                                      /* super space      | 打开浮动 st终端        */
